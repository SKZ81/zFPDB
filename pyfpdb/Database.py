...
#    DON'T FORGET TO RECREATE THEM!!
    ...
    def fillDefaultData(self):
        ...
        c.execute("INSERT INTO Sites (id,name,code) VALUES ('2', 'OnGame', 'OG')")
        c.execute("INSERT INTO Sites (id,name,code) VALUES ('3', 'Betfair', 'BF')")
        c.execute("INSERT INTO Sites (id,name,code) VALUES ('4', 'PartyPoker', 'PP')")
        c.execute("INSERT INTO Sites (id,name,code) VALUES ('5', '888', '88')")
        c.execute("INSERT INTO Sites (id,name,code) VALUES ('6', 'Partouche', 'PA')")
        c.execute("INSERT INTO Sites (id,name,code) VALUES ('7', 'Merge', 'MN')")
        c.execute("INSERT INTO Sites (id,name,code) VALUES ('8', 'iPoker', 'IP')")
        c.execute("INSERT INTO Sites (id,name,code) VALUES ('9', 'Winamax', 'WM')")
        c.execute("INSERT INTO Sites (id,name,code) VALUES ('10', 'BetOnline', 'BO')")
        c.execute("INSERT INTO Sites (id,name,code) VALUES ('11', 'Microgaming', 'MG')")
        c.execute("INSERT INTO Sites (id,name,code) VALUES ('12', 'Bovada', 'BV')")
        c.execute("INSERT INTO Sites (id,name,code) VALUES ('13', 'SealsWithClubs', 'SW')")
        c.execute("INSERT INTO Sites (id,name,code) VALUES ('14', 'WinningPoker', 'WP')")
        #Fill Actions
